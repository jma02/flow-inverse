...
from models.JiT import JiT_B_8
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='circles-eit-cond-dtn-JiT', help='Directory to save models')
    ...
    model = JiT_B_8(in_channels=1, cond_in_channels=1, input_size=128).to(device)
        ...
        with torch.no_grad():
            ...
            def v_field(z, t):
                ...
                with torch.autocast(device_type="cuda", dtype=torch.bfloat16):
                    v_uncond = eval_model(z, t_batch, torch.zeros_like(x_cond))
                    v_cond = eval_model(z, t_batch, x_cond)
