...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='circles-eit-cond-dtn-strong-JiT-ema-nocfg_linear_warmup_x_pred_pinn_no_vel', help='Directory to save models')
