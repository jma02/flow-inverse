...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='circles-eit-cond-dtn-strong-JiT-ema-nocfg_linear_warmup', help='Directory to save models')
    ...
    for epoch in pbar:
        ...
        with torch.no_grad():
            for x_cond, y in val_loader:
                ...
                with torch.autocast(device_type="cuda", dtype=torch.bfloat16):
                    v_pred = eval_model(z_t, t, x_cond)
