...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='circles-eit-concat-unet-flow-default-bgt-sig_t_no_cfg', help='Directory to save models')
        ...
        with torch.no_grad():
            ...
            def v_from_x_pred(z, t):
                ...
                with torch.autocast(device_type="cuda", dtype=torch.bfloat16):
                    ...
                    v_pred = eval_model(z, x_cond, t_batch)
                return v_pred
