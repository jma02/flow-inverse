...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Train a JiT flow matching model for v prediction.")
    parser.add_argument('--device', type=str, default='cuda:0', help='Device to use for training')
    parser.add_argument('--ckpt', type=str, default=None, help='Path to a checkpoint to resume training from')
    parser.add_argument('--save_dir', type=str, default='circles-eit-v-pred-jit', help='Directory to save models')
    ...
    optim = torch.optim.AdamW(model.parameters(), lr=max_lr, betas=(0.9, 0.95), weight_decay=1e-5)
