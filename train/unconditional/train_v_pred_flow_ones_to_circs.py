...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='circles-eit-v-pred-ones-to-circs', help='Directory to save models')
    ...
    for epoch in pbar:
        ...
        model.eval()
        with torch.no_grad():
            x0 = torch.ones(4, 1, 128, 128).to(device)
            x0 = x0 + 0.1*torch.randn_like(x0)
