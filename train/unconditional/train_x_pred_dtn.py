...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='circles-eit-x-pred-dtn-ch-64', help='Directory to save models')
    ...
    for epoch in pbar:
        ...
        with torch.no_grad():
            ...
            def v_from_x_pred(z, t):
                ...
                return (model(z, t_batch) - z) / torch.clip((1 - t_batch)[:, None, None, None], min=5e-2)
