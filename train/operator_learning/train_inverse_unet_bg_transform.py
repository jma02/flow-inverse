...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='circles-eit-inverse-unet-refined-bg-transform', help='Directory to save models')
    parser.add_argument('--data_file', type=str, default='eit-circles-dtn-refined-128.pt', help='Path to the dataset file')
    ...
    mesh_file = "mesh-data/completed_new_mesh.mat"
