...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='circles-eit-triangular-flow-default-bg-transform_run1', help='Directory to save models')
    ...
    model = UnetTriangular(unet_ch=32, y_ch=1, theta_ch=1).to(device)
