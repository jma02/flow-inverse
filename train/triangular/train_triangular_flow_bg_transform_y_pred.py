...
import argparse
from models.triangular import UnetTriangularYPred
...
def get_loss_fn(model: UnetTriangularYPred):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='circles-eit-triangular-flow-default-bg-transform_y_pred', help='Directory to save models')
    ...
    model = UnetTriangularYPred(
        y_pred_ckpt="saved_runs/circles-eit-inverse-unet-interp-y-pred-default-bg-transform/checkpoints/ckp_32750.tar",
    ).to(device)
