...
# Modified for unconditional flow matching (no class conditioning)
# --------------------------------------------------------
import torch
...
class JiTUncond(nn.Module):
    ...
    def __init__(
        ...
        # time embed only (no class conditioning)
    ...
    def forward(self, x, t):
        ...
        t: (N,)
        """
        # timestep embedding only (no class conditioning)
        c = self.t_embedder(t)
